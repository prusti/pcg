...
impl<'a, 'mir: 'a, 'tcx: 'mir> DisplayWithCtxt<&'a PcgCtxt<'mir, 'tcx>> for ty::RegionVid {
    fn display_output(&self, ctxt: &'a PcgCtxt<'mir, 'tcx>, mode: OutputMode) -> DisplayOutput {
        self.display_output(ctxt.compiler_ctxt, mode)
    }
}

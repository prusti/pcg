...
export type AllBlockIterations = { blocks: Partial<{ [key in string]: PcgBlockDotGraphs[] }> }
...
export type PcgBlockDotGraphs = { at_phase: PcgDotFileAtPhase[]; actions: EvalStmtData<PathToDotFile[]> }

export type PcgDotFileAtPhase = { phase: string; filename: PathToDotFile }

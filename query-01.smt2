(get-info :version)
; (:version "4.8.7")
; Started: 2026-04-09 13:47:53
; Silicon.version: 1.1-SNAPSHOT (43512ff6@(detached))
; Input file: <unknown>
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
...
; ------------------------------------------------------------
; ---------- findMaxConsecutiveDifference ----------
(declare-const array@0@01 Seq<Int>)
(declare-const pos@1@01 Int)
(declare-const array@2@01 Seq<Int>)
(declare-const pos@3@01 Int)
(set-option :rlimit 0)
(push) ; 1
...
; [eval] |array| >= 2
; [eval] |array|
(assert (>= (Seq_length array@2@01) 2))
...
; [eval] pos + 1
; [eval] |array|
(assert (< (+ pos@3@01 1) (Seq_length array@2@01)))
(assert (= ($Snap.second ($Snap.second $t@5@01)) $Snap.unit))
; [eval] (forall x: Int :: { array[x] } x >= 0 && x + 1 < |array| ==> array[x + 1] - array[x] <= array[pos + 1] - array[pos])
(declare-const x@6@01 Int)
(push) ; 3
; [eval] x >= 0 && x + 1 < |array| ==> array[x + 1] - array[x] <= array[pos + 1] - array[pos]
; [eval] x >= 0 && x + 1 < |array|
; [eval] x >= 0
(push) ; 4
; [then-branch: 0 | !(x@6@01 >= 0) | live]
; [else-branch: 0 | x@6@01 >= 0 | live]
(push) ; 5
; [then-branch: 0 | !(x@6@01 >= 0)]
(assert (not (>= x@6@01 0)))
(pop) ; 5
(push) ; 5
; [else-branch: 0 | x@6@01 >= 0]
(assert (>= x@6@01 0))
; [eval] x + 1 < |array|
; [eval] x + 1
; [eval] |array|
...
(push) ; 4
; [then-branch: 1 | x@6@01 >= 0 && x@6@01 + 1 < |array@2@01| | live]
; [else-branch: 1 | !(x@6@01 >= 0 && x@6@01 + 1 < |array@2@01|) | live]
(push) ; 5
; [then-branch: 1 | x@6@01 >= 0 && x@6@01 + 1 < |array@2@01|]
(assert (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01))))
; [eval] array[x + 1] - array[x] <= array[pos + 1] - array[pos]
; [eval] array[x + 1] - array[x]
; [eval] array[x + 1]
; [eval] x + 1
(push) ; 6
(assert (not (>= (+ x@6@01 1) 0)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; [eval] array[x]
(push) ; 6
(assert (not (< x@6@01 (Seq_length array@2@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
; (get-info :all-statistics)
; [eval] array[pos + 1] - array[pos]
; [eval] array[pos + 1]
; [eval] pos + 1
(push) ; 6
(assert (not (>= (+ pos@3@01 1) 0)))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
; [eval] array[pos]
(push) ; 6
(assert (not (< pos@3@01 (Seq_length array@2@01))))
(check-sat)
; unsat
(pop) ; 6
; 0.00s
...
(pop) ; 5
(push) ; 5
; [else-branch: 1 | !(x@6@01 >= 0 && x@6@01 + 1 < |array@2@01|)]
(assert (not (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01)))))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or
  (not (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01))))
  (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01)))))
(pop) ; 3
; Nested auxiliary terms: globals (aux)
; Nested auxiliary terms: non-globals (aux)
(assert (forall ((x@6@01 Int)) (!
  (and
    (or (>= x@6@01 0) (not (>= x@6@01 0)))
    (or
      (not (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01))))
      (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01)))))
  :pattern ((Seq_index array@2@01 x@6@01))
  :qid |prog./Users/thomas/Downloads/skeleton/task2.vpr@8@13@8@126-aux|)))
(assert (forall ((x@6@01 Int)) (!
  (=>
    (and (>= x@6@01 0) (< (+ x@6@01 1) (Seq_length array@2@01)))
    (<=
      (- (Seq_index array@2@01 (+ x@6@01 1)) (Seq_index array@2@01 x@6@01))
      (- (Seq_index array@2@01 (+ pos@3@01 1)) (Seq_index array@2@01 pos@3@01))))
  :pattern ((Seq_index array@2@01 x@6@01))
  :qid |prog./Users/thomas/Downloads/skeleton/task2.vpr@8@13@8@126|)))
(pop) ; 2
(push) ; 2
; [exec]
; inhale false
